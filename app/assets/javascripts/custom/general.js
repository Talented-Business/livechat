...
jQuery(document).ready(function(){
  ...
  thedate = $("#schedule_thedate").html();
  action_url = $("#schedule_action_url").html();
	jQuery(".schedule-week-today").click(function(){
    data = {
      date:thedate,
      arrow:"today"
    }
    url = jQuery("#schedule_action_url").html();
  });
	jQuery(".schedule-week-previous").click(function(){
    data = {
      date:thedate,
      arrow:"previous"
    }
  });
	jQuery(".schedule-week-next").click(function(){
    data = {
      date:thedate,
      arrow:"next"
    }
  ...
  $(".bookable_span").click(function(){
    $(".goto_workpage").hide();
    $(this).find("form").submit();
  });
  $(".booked_span").click(function(){
    $(this).find("form").submit();
  });
  $(".booked_span").mouseover(function(){
    $(".goto_workpage").show();
    s = $(this).position();
    $(".goto_workpage").css("top",s.top+20);
    $(".goto_workpage").css("left",s.left);    
  });
  $(".booked_span").parents("td").mouseleave(function(){
    $(".goto_workpage").hide();
  });  
  $(".goto_workpage").mouseleave(function(){
    //$(this).attr("id","goto");
    $(".goto_workpage").hide();
  });  
  $(".goto_workpage").mouseover(function(){
    $(".goto_workpage").show();
  });  
  $(".goto_workpage").hide();
  $(".obtnclose").click(function(){
    $(this).parents(".oskill").hide();
  });
